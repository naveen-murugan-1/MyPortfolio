...
Message: ${message}
    ...
    const linksHtml = linkList.map(link => `
            <a href="${link.url}" target="_blank"
               style="color:#DC143C;text-decoration:none;font-size:13px;margin:0 6px;">
               ${link.platform}
            </a>
          ...
          <table width="600" cellpadding="0" cellspacing="0"
            ...
            <tr>
              <td style="padding:10px 30px;text-align:center;">
                ...
                <p style="color:#cbd5e1;font-size:15px;line-height:1.7;">
                  You can expect a reply within <strong style="color:#DC143C;">24 hours</strong>.
                </p>
                ...
                <table>
                  <tr>
                    <td style="padding:5px 10px;">
                      <a href="https://www.linkedin.com/in/naveenmurugan19042007/" style="color:#DC143C;text-decoration:none;font-size:13px;">
                        💼 LinkedIn
                      </a>
                    </td>
                    <td style="padding:5px 10px;">
                      <a href="https://github.com/naveen-murugan-1" style="color:#DC143C;text-decoration:none;font-size:13px;">
                        💻 GitHub
                      </a>
                    </td>
                    <td style="padding:5px 10px;">
                      <a href="https://praveenmurugan.me" style="color:#DC143C;text-decoration:none;font-size:13px;">
                        🌐 Portfolio
                      </a>
                    </td>
                    <td style="padding:5px 10px;">
                      <a href="https://wa.me/918300984480" style="color:#DC143C;text-decoration:none;font-size:13px;">
                        📱 WhatsApp
                      </a>
                    </td>
                  </tr>
            ...
            <tr>
              <td style="padding:25px;text-align:center;border-top:1px solid #1e293b;">
                ...
                <p style="color:#DC143C;font-size:16px;font-weight:bold;margin:10px 0;">
                  Naveen M
                </p>
