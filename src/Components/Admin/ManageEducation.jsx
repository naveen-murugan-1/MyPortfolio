                ...
                <div className="space-y-4">
                    ...
                    {educationList.length === 0 ? (
                        ...
                        educationList.map((edu) => (
                            <div key={edu._id} className="bg-gray-950 p-4 rounded-lg border border-gray-700 group hover:border-violet-400/50 transition-colors relative">
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-2">
                                        {edu.courses.map((c, i) => (
                                            <span key={i} className="text-xs bg-black px-2 py-1 rounded text-gray-400 border border-gray-700">
                                                {c}
                                            </span>
                                        ))}
                                    </div>
