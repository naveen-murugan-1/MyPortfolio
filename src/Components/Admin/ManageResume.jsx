...
const ManageResume = () => {
    ...
    return (
        <div className="p-6">
            ...
            <div className="bg-gray-950 p-6 md:p-8 rounded-xl border border-gray-700 max-w-2xl">
                <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 text-sm">Provide a public link to your resume (URL)</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSave} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-black border border-gray-600 rounded p-3 text-white focus:outline-none focus:border-violet-400"
                                required
                            />
                        </div>
