...
const ManageSkills = () => {
    ...
    return (
        <div>
            ...
            {/* Add/Edit Form */}
            <form onSubmit={handleSubmit} className="bg-gray-950 p-6 rounded mb-8 space-y-4">
                <input
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {skills.map(skill => (
                    <div key={skill._id} className="group bg-gray-950 p-4 rounded flex justify-between items-start">
                        <div>
                            <h3 className="font-bold text-violet-400">{skill.category}</h3>
