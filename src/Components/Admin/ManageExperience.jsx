                ...
                <div className="bg-gray-950 p-6 rounded-lg border border-gray-700 h-fit">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex gap-2 justify-end pt-2">
                            ...
                            <button
                                type="submit"
                                className="bg-violet-600 hover:bg-violet-500 text-white px-6 py-2 rounded flex items-center gap-2"
                            >
                ...
                <div className="space-y-4">
                    ...
                    {experienceList.length === 0 ? (
                        ...
                        experienceList.map((exp) => (
                            <div key={exp._id} className="group bg-gray-950 p-4 rounded-lg border border-gray-700 hover:border-violet-400/50 transition-colors">
                                <div className="flex justify-between items-start mb-3">
                                    <div>
                                        <h4 className="font-bold text-lg text-white">{exp.role}</h4>
                                        <p className="text-violet-400 font-medium">{exp.company} <span className="text-gray-500 text-sm font-normal">• {exp.type}</span></p>
