        ...
        <div className="max-w-4xl mx-auto px-4">
            <div className="flex justify-between items-center mb-8">
                ...
                <button
                    ...
                    className="flex items-center gap-2 bg-gray-950 border border-gray-700 hover:border-violet-500 text-violet-400 px-4 py-2 rounded-lg text-sm transition-all"
                >
                ...
                <div className="fixed inset-0 z-50 bg-black overflow-y-auto pt-16">
                    <div className="absolute top-4 right-4 z-50">
                        <button 
                            ...
                            className="bg-black/80 border border-gray-800 p-2 rounded-full text-white hover:bg-violet-950 hover:border-violet-500 transition-all"
                        >
                            <X size={24} />
                        </button>
                    </div>
            ...
            {/* Add/Edit Form */}
            <form onSubmit={handleSubmit} className="bg-gray-950 p-8 rounded-2xl  mb-12 border border-gray-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <input
                                    ...
                                    className="flex-1 p-2 self-center bg-black border border-gray-700 rounded text-sm text-white focus:outline-none focus:border-violet-500"
                    ...
                    <div className="space-y-4">
                        <input
                            ...
                            className="w-full p-3 bg-black border border-gray-700 rounded-lg text-white focus:ring-2 focus:ring-violet-500 outline-none"
                    ...
                    <div className="md:col-span-2">
                        <textarea
                            ...
                            className="w-full p-3 bg-black border border-gray-700 rounded-lg text-white focus:ring-2 focus:ring-violet-500 outline-none h-20 resize-none text-sm"
                ...
                <div className="flex justify-end gap-3">
                    ...
                    <button
                        type="submit"
                        className="flex items-center gap-2 bg-violet-600 hover:bg-violet-500 text-white px-6 py-3 rounded-lg font-medium transition-colors  -600/20"
                    >
                        <Save size={18} />
                        {editId ? 'Update' : 'Save'}
                    </button>
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <button
                    ...
                    className="bg-violet-500/10 border border-violet-500/30 text-violet-400 px-3 py-1.5 rounded-lg text-sm hover:bg-violet-500 hover:text-white transition-all disabled:opacity-50"
                >
            ...
            <Reorder.Group values={certificates} onReorder={setCertificates} className="space-y-4">
                {certificates.map(cert => (
                    <Reorder.Item key={cert._id} value={cert} className="group cursor-grab active:cursor-grabbing bg-gray-950/50 p-4 rounded-xl border border-gray-700 flex justify-between items-center hover:bg-gray-950 transition-colors">
                        <div className="flex items-center gap-4">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="bg-violet-500/10 text-violet-500 hover:bg-violet-500 hover:text-white p-2 rounded-lg transition-all"
                                title="Edit"
                            >
                                <Edit2 size={16} />
                            </button>
