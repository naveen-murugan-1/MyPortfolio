...
const ManageContactDetail = () => {
    ...
    return (
        <div className="p-6">
            ...
            {profile && (
                <div className="bg-gray-950 p-6 rounded-lg border border-gray-700 mb-8 max-w-2xl">
                    <h3 className="text-xl font-semibold text-violet-400 mb-4">Main Contact Info</h3>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                {/* Form Section */}
                <div className="bg-gray-950 p-6 rounded-lg border border-gray-700 h-fit">
                ...
                <div className="space-y-4">
                    ...
                    {linksList.length === 0 ? (
                        ...
                        <div className="grid gap-4">
                            {linksList.map((link) => (
                                <div key={link._id} className="bg-gray-950 p-4 rounded-lg border border-gray-700 group hover:border-violet-400/50 transition-colors relative flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <a href={link.url} target="_blank" rel="noopener noreferrer" className="text-violet-400 text-sm flex items-center gap-1 hover:underline">
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            ...
                                            className="p-2 text-violet-400 hover:bg-violet-400/10 rounded"
                                            title="Edit"
                                        >
