            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {sections.map(section => (
                        <div key={section} className="bg-gray-950 p-4 rounded-xl border border-gray-700 hover:border-violet-400/40 transition-all">
                            <div className="flex justify-between items-center mb-3">
                                <label className="block text-white capitalize font-bold tracking-wide">{section}</label>
                            ...
                            {profile.sectionBackgrounds?.[section] ? (
                                <div className="w-full h-36 rounded-lg overflow-hidden relative mb-3 border border-gray-600  group">
                                ...
                                <div className="w-full h-36 bg-black/80 rounded-lg flex flex-col items-center justify-center text-gray-600 text-sm border-2 border-dashed border-gray-700 mb-3">
                            ...
                            <input
                                ...
                                className="w-full bg-black border border-gray-600 rounded-lg p-2 text-white focus:outline-none focus:border-violet-400 text-xs font-sans tracking-wide"
                            />
                        </div>
                    ))}
                </div>
                ...
                <div className="flex justify-end mt-4">
                    <button
                        type="submit"
                        disabled={saving}
                        className="bg-violet-600 hover:bg-violet-500 text-white px-8 py-2.5 rounded-xl flex items-center gap-2 font-bold  -500/10 disabled:opacity-50 transition-all"
                    >
