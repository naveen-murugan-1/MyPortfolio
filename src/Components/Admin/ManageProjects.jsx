...
const ManageProjects = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="bg-gray-950 p-8 rounded-2xl  mb-12 border border-gray-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                <label className="text-xs text-gray-500">Paste Image URL below:</label>
                                <input
                                    type="text"
                                    placeholder="Paste Image URL"
                                    className="w-full mt-1 p-2 bg-black border border-gray-700 rounded text-sm text-white focus:outline-none focus:border-blue-500"
                    ...
                    <div className="space-y-4">
                        <input
                            ...
                            className="w-full p-3 bg-black border border-gray-700 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                            value={formData.title} onChange={(e) => setFormData({ ...formData, title: e.target.value })}
                        />
                        <input
                            type="text" placeholder="Category (e.g. EMBEDDED_LOGIC)"
                            className="w-full p-3 bg-black border border-gray-700 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                ...
                <div className="space-y-6">
                    ...
                    <textarea
                        ...
                        className="w-full p-3 bg-black border border-gray-700 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all resize-none"
                ...
                <div className="mt-8 flex justify-end gap-3">
                    ...
                    <button
                        type="submit"
                        disabled={uploading}
                        className={`flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-6 py-3 rounded-lg font-medium transition-colors  -600/20 ${uploading ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
                        <Save size={18} />
            ...
            <div className="space-y-4">
                {projects.map(proj => (
                    <div key={proj._id} className="group bg-gray-950/50 p-4 rounded-xl border border-gray-700 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 hover:bg-gray-950 transition-colors">
                        <div className="flex items-center gap-4">
