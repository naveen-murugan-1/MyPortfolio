    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <form onSubmit={handleSubmit} className="bg-gray-950 p-6 rounded-lg border border-gray-700 space-y-6 h-fit">
                    <h3 className="text-xl font-semibold text-violet-400 border-b border-gray-700 pb-2 mb-4">Edit Profile</h3>
                            ...
                            <div className="flex-1">
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full p-2 bg-black border border-gray-600 rounded text-sm text-white focus:outline-none focus:border-violet-400"
                                        value={profile.profileImage || ''}
                                        onChange={(e) => setProfile({ ...profile, profileImage: e.target.value })}
                                    />
                                </div>
                                <p className="text-xs text-gray-500 mt-2">Enter the standard image viewing URL.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-black border border-gray-600 rounded p-2 text-white focus:outline-none focus:border-violet-400"
                                required
                            />
                        </div>
                        <div>
                    ...
                    <div className="border-t border-gray-700 pt-4">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-lg font-semibold text-violet-400">{editIndex !== null ? 'Edit Leadership Role' : 'Add New Leadership'}</h3>
                            {editIndex !== null && (
                        ...
                        <div className={`space-y-4 bg-black/50 p-4 rounded border ${editIndex !== null ? 'border-violet-500/50' : 'border-gray-700'}`}>
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-950 border border-gray-600 rounded p-2 text-white focus:outline-none focus:border-violet-400"
                            ...
                            <button
                                ...
                                className={`w-full py-2 rounded flex items-center justify-center gap-2 transition-all ${editIndex !== null
                                    ...
                                    : 'bg-violet-600/20 hover:bg-violet-600/30 text-violet-400 border border-violet-400/30'
                                    }`}
                            >
                    ...
                    <div className="flex justify-end">
                        <button
                            type="submit"
                            disabled={saving}
                            className="bg-violet-600 hover:bg-violet-500 text-white px-6 py-2 rounded flex items-center gap-2 disabled:opacity-50"
                        >
                ...
                <div className="space-y-6">
                    <div className="sticky top-6 space-y-6">
                        ...
                        <div className="bg-gray-950 border border-gray-700 p-6 rounded-xl">
                            <h3 className="text-lg font-semibold text-violet-400 mb-4 border-b border-gray-700 pb-2">Profile Summary</h3>
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-violet-400 text-sm">{profile.title}</p>
                                </div>
                            </div>
                            <div className="mb-4">
                        ...
                        <div className="bg-gray-950 border border-violet-700 p-6 rounded-xl">
                            <h3 className="text-lg font-semibold text-violet-400 mb-4 border-b border-violet-700 pb-2">Leadership History</h3>
                                    ...
                                    {profile.leadership.map((item, index) => (
                                        <div
                                            ...
                                            className={`p-3 rounded border transition-all ${editIndex === index
                                                ...
                                                : 'bg-black/50 border-violet-700 hover:border-violet-500'
                                                }`}
                                        >
                                            <div className="flex justify-between items-start">
                                                <div>
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {item.period && (
                                                            <span className="text-xs text-violet-400 bg-violet-400/10 px-1.5 py-0.5 rounded border border-violet-400/20">{item.period}</span>
                                                        )}
                                                    </div>
                                                ...
                                                <div className="flex gap-1">
                                                    <button
                                                        ...
                                                        className="p-1.5 text-violet-400 hover:text-violet-400 hover:bg-violet-700 rounded transition-colors"
                                                        title="Edit"
                                                    >
                                                        <Pencil size={18} />
                                                    </button>
