                ...
                <div className="space-y-4">
                    ...
                    {achievements.length === 0 ? (
                        ...
                        achievements.map((item) => (
                            <div key={item._id} className="bg-gray-950 p-4 rounded-lg border border-gray-700 group hover:border-violet-400/50 transition-colors">
                                <div className="flex justify-between items-start">
                                    <div className="flex gap-3">
                                        <div className="bg-violet-400/10 p-2 rounded h-fit">
                                            <Trophy size={20} className="text-violet-400" />
                                        </div>
                                        <div>
                                            <h4 className="font-bold text-lg text-white">{item.title}</h4>
                                            <p className="text-sm text-violet-400 mb-1">{item.date}</p>
