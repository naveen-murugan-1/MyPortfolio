    ...
    return (
        <div className="p-6">
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                <Mail className="text-violet-400" /> Messages ({messages.length})
            </h2>
            ...
            <div className="grid gap-4">
                {messages.length === 0 ? (
                    ...
                    messages.map((msg) => (
                        <div key={msg._id} className="bg-gray-950 p-6 rounded-lg border border-gray-700">
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    <h3 className="text-xl font-bold text-violet-400">{msg.name}</h3>
