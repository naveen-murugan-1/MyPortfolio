...
const AdminDashboard = () => {
    ...
    return (
        <div className="flex h-screen overflow-hidden bg-black text-white">
            {/* Mobile Header */}
            <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-gray-950 z-40 flex items-center justify-between px-4 border-b border-gray-700">
            ...
            {/* Sidebar */}
            <div className={`
                fixed inset-y-0 left-0 z-50 w-64 bg-gray-950 p-6 flex flex-col transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:inset-auto
